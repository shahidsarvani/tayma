...
@section('content')
    <div class="card">
        <div class="card-header">
            <h5 class="card-title">Add Touchtable Timeline Item</h5>
        </div>

        <div class="card-body">
            <form action="{{ route('touchtable.timeline.store') }}" method="post">
                @csrf
                <div class="row">
                    <div class="col-md-4">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea name="description" id="editor-full1" rows="4" cols="4" required></textarea>
                            @error('description')
