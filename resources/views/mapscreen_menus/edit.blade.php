...
@section('content')
    <div class="card">
        <div class="card-header">
            <h5 class="card-title">Edit Map Menu</h5>
        </div>

        <div class="card-body">
            <form action="{{ route('map.menus.update', $menu->id) }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="image-area_">
                            <div class="image-area">
                                @if($menu->bg_image != null)
                                    ...
                                    <a class="remove-image" href="{{ route('map.menu.remove.bg', $menu->id) }}"
                    ...
                    <div class="col-md-12">
                        <div
                            ...
                            id="image_partial">
                            @include('mapscreen_menus.image_partial')
                        </div>
                        <div
                            class="hidden {{ (($menu->icon_en && $menu->icon_en != '') || ($menu->icon_ar && $menu->icon_ar != '')) ? 'show' : '' }}"
                            id="icon_partial">
                            @include('mapscreen_menus.icon_partial')
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="image-area_">
                            ...
                            <div class="col-md-3 my-2">
                                ...
                                @else
                                    <div class="image-area-">
                                        ...
                                        <a class="remove-image"
                                           href="{{ route('map.gallery.delete', $item->id) }}"
                                           style="display: inline;">&#215;</a>
                                    </div>
        ...
        <form action="{{ route('map.media.upload') }}" class="dropzone mt-3" id="dropzone_multiple"></form>
        <form action="{{ route('map.media.upload') }}" class="dropzone mt-3" id="dropzone_multiple_ar"></form>
        <form action="{{ route('map.media.upload') }}" class="dropzone mt-3" id="dropzone_multiple_bg"></form>
